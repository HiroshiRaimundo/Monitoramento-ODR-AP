...
import { getFrequencyColor, getCategoryBorderColor } from "./monitoringUtils";

interface MonitoringItemProps {
  item: MonitoringItemType;
  onDelete: (id: string) => void;
}

const MonitoringItem: React.FC<MonitoringItemProps> = ({ item, onDelete }) => {
  return (
    <Card 
